      ...
      <div className="relative aspect-video w-full shrink-0 overflow-hidden bg-muted">
        {video.image ? (
          ...
          <div className="flex size-full items-center justify-center">
            <HugeiconsIcon icon={Video01Icon} className="size-16 text-muted-foreground/50" strokeWidth={1.5} />
          </div>
        )}
        <div className="absolute inset-0 flex items-center justify-center bg-black/20 opacity-0 transition-opacity group-hover:opacity-100">
          <div className="flex size-14 items-center justify-center rounded-full bg-white/90">
            <HugeiconsIcon icon={PlayIcon} className="size-7 text-primary" strokeWidth={2} />
          </div>
        </div>
      </div>
