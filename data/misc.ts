export const injectors = [
  { key: "processHacker2", link: "files/processhacker.exe", image: "/tools/processhacker.png" },
...
export const tools = [
  { key: "allCppInstaller", link: "files/cppinstaller.zip", image: "/tools/cplusplus.png" },
  { key: "allDotNetInstaller", link: "files/dotnetinstaller.exe", image: "/tools/dotnet.png" },
]
